...
\Hypertarget{index_md_README}%
 ...
 Qt Designer is used to generate Python code from designed user interface.\hypertarget{index_autotoc_md1}{}\doxysection{Dependencies}\label{index_autotoc_md1}
